        ...
        <div className={Classes.DIALOG_BODY}>
          {this.props.user[0] && <div className="Profile-container">
            <div className="Profile-icon">
              {this.props.user[0].profilePicture ? <div className="Profile-pfp"><img src={"https://" + this.props.user[0].profilePicture + "?t=" + Number(Date.now())}/></div> : <div className="Profile-pfp"/>}
            </div>
